...
public class SavingsGoalEntity extends BaseEntity {
    ...
    private List<GoalParticipantEntity> participants = new ArrayList<GoalParticipantEntity>();

    @OneToMany(mappedBy = "goal", cascade = CascadeType.ALL, orphanRemoval = true)
    private List<GoalActivityEntity> activities = new ArrayList<GoalActivityEntity>();
    ...
    public void addActivity(GoalActivityEntity activity) {
